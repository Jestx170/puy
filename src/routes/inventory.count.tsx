...
export const Route = createFileRoute("/inventory/count")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "รอบการตรวจนับและผลต่างที่พบในแต่ละคลัง" },
      { property: "og:title", content: "ตรวจนับสต็อก — ปุ๋ยไทย CRM" },
      { property: "og:description", content: "รอบการตรวจนับและผลต่างที่พบในแต่ละคลัง" },
  ...
  component: () => (
    <InventoryOpsPage
      title="ตรวจนับสต็อก"
      description="รอบการตรวจนับและผลต่างที่พบในแต่ละคลัง"
