...
export const Route = createFileRoute("/inventory/stock-out")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "บันทึกการจ่ายสินค้าออกจากคลังไปยังหน้าร้านหรือลูกค้า" },
      { property: "og:title", content: "จ่ายสินค้าออก — ปุ๋ยไทย CRM" },
      {
        property: "og:description",
        content: "บันทึกการจ่ายสินค้าออกจากคลังไปยังหน้าร้านหรือลูกค้า",
      },
  ...
  component: () => (
    <InventoryOpsPage
      title="จ่ายสินค้าออก"
      description="บันทึกการจ่ายสินค้าออกจากคลังไปยังหน้าร้านหรือลูกค้า"
      type={"จ่ายออก"}
